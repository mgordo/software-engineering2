...
/**
 * This is the item provider adapter for a {@link OurPNVis.Geometry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeometryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Geometry_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Geometry_text_feature", "_UI_Geometry_type"),
				 OurPNVisPackage.Literals.GEOMETRY__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Geometry)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Geometry.class)) {
			case OurPNVisPackage.GEOMETRY__TEXT:
