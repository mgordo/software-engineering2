...
public class AnimationsPackageImpl extends EPackageImpl implements AnimationsPackage {
	 ...
	 */
	@Override
	public EReference getSequence_Contains() {
	 ...
	 */
	@Override
	public EAttribute getAppear_Time() {
	...
	public void createPackageContents() {
		...
		createEReference(sequenceEClass, SEQUENCE__CONTAINS);
		...
		createEAttribute(appearEClass, APPEAR__TIME);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getSequence_Contains(), this.getAnimation(), null, "contains", null, 1, -1, Sequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMove_Speed(), ecorePackage.getEInt(), "speed", null, 1, 1, Move.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(triggerEClass, Trigger.class, "Trigger", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(appearEClass, Appear.class, "Appear", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAppear_Time(), ecorePackage.getEInt(), "time", null, 1, 1, Appear.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
