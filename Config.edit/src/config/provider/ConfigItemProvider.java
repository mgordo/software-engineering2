...
/**
 * This is the item provider adapter for a {@link config.Config} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Config_petri_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Config_petri_feature", "_UI_Config_type"),
				 ConfigPackage.Literals.CONFIG__PETRI,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addGeoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Config_geo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Config_geo_feature", "_UI_Config_type"),
				 ConfigPackage.Literals.CONFIG__GEO,
				 true,
				 false,
				 true,
				 null,
