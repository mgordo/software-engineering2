...
public class SequenceItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AnimationsPackage.Literals.SEQUENCE__CONTAINS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Sequence.class)) {
			case AnimationsPackage.SEQUENCE__CONTAINS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AnimationsPackage.Literals.SEQUENCE__CONTAINS,
