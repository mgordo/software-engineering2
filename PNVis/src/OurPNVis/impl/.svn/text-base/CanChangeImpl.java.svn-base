...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Can Change</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link OurPNVis.impl.CanChangeImpl#isText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CanChangeImpl extends AttributeImpl implements CanChange {
	/**
	...
	protected EClass eStaticClass() {
		return OurPNVisPackage.Literals.CAN_CHANGE;
	}
	...
	public void setText(boolean newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OurPNVisPackage.CAN_CHANGE__TEXT, oldText, text));
	}
