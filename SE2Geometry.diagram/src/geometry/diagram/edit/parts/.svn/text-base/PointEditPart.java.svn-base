...
import geometry.diagram.edit.policies.PointItemSemanticEditPolicy;
...
public class PointEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof geometry.diagram.edit.parts.PointEditPart) {
			types.add(GeometryElementTypes.Line_4001);
		}
		return types;
	}
	 ...
	 * @generated
	 */
	public class PointFigure extends RectangleFigure {
