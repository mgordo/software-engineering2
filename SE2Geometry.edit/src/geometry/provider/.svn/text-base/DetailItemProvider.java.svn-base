...
/**
 * This is the item provider adapter for a {@link geometry.Detail} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DetailItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Detail_texture_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Detail_texture_feature", "_UI_Detail_type"),
				 GeometryPackage.Literals.DETAIL__TEXTURE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Detail)object).getTexture();
